...
export const translations = {
  en: {
    ...
    whitelistTip: "Tip: Export your whitelist to save it as a backup. You can import it later to restore your saved users.",
  ...
  es: {
    ...
    whitelistTip: "Consejo: Exporta tu lista blanca para guardarla como respaldo. Puedes importarla más tarde para restaurar tus usuarios guardados.",
